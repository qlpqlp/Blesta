...
class SupportManagerPlugin extends Plugin {
	...
	public function install($plugin_id) {
        ...
        $putbchatcode = '<?include(PLUGINDIR . DS . "support_manager" . DS . "views" . DS . "default" . DS . "admin_support_manager_count_include.pdt");?></body>
</html>';
	...
	public function uninstall($plugin_id, $last_instance) {
        ...
        //because we cannot get the ID from a field we will add the code to make the magic
        $findcode = '<?include(PLUGINDIR . DS . "support_manager" . DS . "views" . DS . "default" . DS . "admin_support_manager_count_include.pdt");?>';
        $rmbchatcode = '';
        $path_to_file = VIEWDIR . "admin" . DS . "default" . DS . "structure.pdt";
