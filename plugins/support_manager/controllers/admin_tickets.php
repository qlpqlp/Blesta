...
class AdminTickets extends SupportManagerController {
	...
	public function index() {
            ...
            $resultadosm = implode(',', $data['selectedtickets']);
                ...
                if (isset($data['closed'])) {
                    ...
                    $multiarray=count($gtid);
                        ...
                        {
                            $this->SupportManagerTickets->ClosedStatus($gtid[$x]);
                ...
                if (isset($data['spam'])) {
                    ...
                    $multiarray=count($gtid);
                        ...
                        for($x=0;$x<$multiarray;$x++)
                        {
                            $this->SupportManagerTickets->SpamStatus($gtid[$x]);
                ...
                if (isset($data['deleted'])) {
                    ...
                    $multiarray=count($gtid);
                        ...
                        for($x=0;$x<$multiarray;$x++)
                        {
                            $this->SupportManagerTickets->DeletedStatus($gtid[$x]);
                ...
                if (isset($data['merge'])) {
                    ...
                    $multiarray=count($gtid);
                        ...
                        {
                            if ($x > 0){
                            $this->SupportManagerTickets->MergeTickets($gtid[$x],$gtid[0]);
                            }
                         }
                ...
                if (isset($data['purge'])) {
                    ...
                    $multiarray=count($gtid);
                        ...
                        for($x=0;$x<$multiarray;$x++)
                        {
                            $this->SupportManagerTickets->PurgeTickets($gtid[$x]);
        ...
        if (isset($this->post['reply_id'])) {
                            $this->SupportManagerTickets->PurgeReply($this->post['reply_id']);
        }
		...
		$status_count = array(
			...
			'spam' => $this->SupportManagerTickets->getStatusCount("spam", $this->staff_id),
			'deleted' => $this->SupportManagerTickets->getStatusCount("deleted", $this->staff_id)
		);
	...
	public function client() {
		...
		$status_count = array(
			...
			'spam' => $this->SupportManagerTickets->getStatusCount("spam", $this->staff_id, $client->id),
			'deleted' => $this->SupportManagerTickets->getStatusCount("deleted", $this->staff_id, $client->id)
		);
