<?php
/**
 * Internetbs API processor
 *
 * @package internetbs
 */
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . "internetbs_response.php";
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . "commands" . DIRECTORY_SEPARATOR . "internetbs_all.php";
class InternetbsApi {

	const SANDBOX_URL = "https://testapi.internet.bs";
	const LIVE_URL = "https://api.internet.bs";
...
//mail("vidal@weblx.pt", $semformat."<->".$command, $response);//echo $response;
		return new InternetbsResponse($response);
	}
